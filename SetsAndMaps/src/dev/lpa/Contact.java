...
public class Contact {
    ...
    public Contact(String name, String email, long phone){
        ...
        // Transform phone if it is not 0
        if(phone > 0){
    ...
    /**
     * Takes a contact and returns a new Contact instance, which
     * merges the current instance with the Contact passed.
     * @param contact a Contact type consisting of a name, set of emails, and
